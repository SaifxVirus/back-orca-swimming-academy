    ...
    <div className="app-shell" dir="rtl">
      ...
      <main className="main-content">
        ...
        <div className="page-wrap">
          ...
          {view === 'المدفوعات' && <OperationsPage title="المدفوعات" kind="payments" rows={payments} swimmers={swimmers} onSaved={loadData} />}
